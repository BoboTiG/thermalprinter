...
#
# html_title = 'ThermalPrinter v0.1.0'
...
latex_documents = [
    (master_doc, 'ThermalPrinter.tex', 'ThermalPrinter Documentation',
     'Tiger-222', 'manual'),
]
...
man_pages = [
    (master_doc, 'thermalprinter', 'ThermalPrinter Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ThermalPrinter', 'ThermalPrinter Documentation',
     author, 'ThermalPrinter', 'One line description of project.',
     'Miscellaneous'),
]
