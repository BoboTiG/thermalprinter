...
from .exceptions import ThermalPrinterCommunicationError, ThermalPrinterValueError
...
class ThermalPrinter(Serial):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Printer settings
        self.send_command(
            Command.ESC, 55, self.most_heated_point, self.heat_time, self.heat_interval
        )
    ...
    def barcode_position(
        self, position: BarCodePosition = BarCodePosition.HIDDEN
    ) -> None:
        """
    ...
    def image(self, image: "Image") -> None:
        ...
        :param Image image: the PIL Image to use.
